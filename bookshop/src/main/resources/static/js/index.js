var myApp = angular.module('myApp', ['ngMaterial', 'ngMessages', 'validation.match']);
//var myApp = angular.module('myApp', ['ngMaterial', 'ngMessages', 'validation.match', 'material.svgAssetsCache']);
myApp.config(function ($mdThemingProvider) {
    $mdThemingProvider.theme('green', 'default').primaryPalette('green');
    $mdThemingProvider.theme('docs-dark', 'default').primaryPalette('green');
    $mdThemingProvider.theme('dark-yel', 'default').primaryPalette('yellow').dark();
});
